...
#     input_request = request.get_json(silent=True)
#     print("request->" + str(input_request))
#     url = 'http://mobilitycoe.genpact.com:9906/gnip172classifier/neural-chat/getResults'  # 'http://mobilitycoe.genpact.com:9906/cititest/neural-chat/getResults'
#     data = input_request
