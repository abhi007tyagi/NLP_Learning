...
# print(j.get_context("can you get answer to 10 / 5"))
# print(j.get_context("hey! can you move up the ladder?"))
# print(j.get_context("hey, how are you today?"))
print(math_cal.get_math_evaluation("can you answer what 1 subtracted from 10 is?"))
...
print(math_cal.get_math_evaluation("5 minus 3"))
